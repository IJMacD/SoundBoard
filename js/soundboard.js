...
var hundred_important = [["的","dik1","Of"],["一","jat1","A"],["是","si6","Be"],["不","bat1","Not"],["了","liu5","The"],["在","zoi6","In"],["人","jan4","People"],["有","jau5 jau6","Have"],["我","ngo5","I"],["他","taa1 to1","He"],["這","ze2 ze3 ze5","This"],["個","go3","A"],["們","mun4","They"],["中","zung1 zung3","In"],["來","lai4 loi4 loi6","Come"],["上","soeng5 soeng6","On"],["大","daai6","Large"],["為","wai4 wai6","To"],["和","wo4 wo6","And"],["國","gwok3","Country"],["地","dei6 deng6","Ground"],["到","dou3","To"],["以","ji5","With"],["說","jyut6 seoi3 syut3","Say"],["時","si4","Time"],["要","jiu1 jiu3","Wish"],["就","zau6","On"],["出","ceot1","Out"],["會","kui2 wui5 wui6","Can"],["可","ho2","Can"],["也","jaa5","Also"],["你","nei5","You"],["對","deoi3","To"],["生","saang1 sang1","Raw"],["能","nang4","Can"],["而","ji4","And"],["子","zi2","Child"],["那","naa5 naa6 no1 no4 no5 no6","That"],["得","dak1","Get"],["於","jyu1 wu1","At"],["著","zoek3 zoek6 zyu3","With"],["下","haa5 haa6","Next"],["自","zi","From"],["之","zi1","The"],["年","nin4","Years"],["過","gwo1 gwo3","Cross"],["發","faat3","Hair"],["後","hau6","After"],["作","zok3","Make"],["裡","lei5","In"],["用","jung6","Use"],["道","dou3 dou6","Road"],["行","haang4 hang4 hang6 hong4","Row"],["所","so2","The"],["然","jin4","However"],["家","gaa1 gu1","Home"],["種","zung2 zung3","Seed"],["事","si6","Thing"],["成","cing4 seng4 sing4","Become"],["方","fong1","Square"],["多","do1","Multi-"],["經","ging1","After"],["麼","maa1 mo1","What"],["去","heoi2 heoi3","Go"],["法","faat3","Law"],["學","hok6","Learn"],["如","jyu4","As"],["都","dou1","Both"],["同","tung4","With"],["現","jin6","Present"],["當","dong1 dong3","When the"],["沒","mut6","Not"],["動","dung6","Move"],["面","min6","Surface"],["起","hei2","Start"],["看","hon1 hon3","Look"],["定","deng6 ding6","Fixed"],["天","tin1","Day"],["分","fan1 fan6","Minute"],["還","syun4 waan4","Also"],["進","zeon3","Enter"],["好","hou2 hou3","Good"],["小","siu2","Small"],["部","bou6","Department"],["其","gei1 kei4","Its"],["些","se1","Some"],["主","zyu2","Main"],["樣","joeng6","Sample"],["理","lei5","Reason"],["心","sam1","Heart"],["她","ji1 taa1","She"],["本","bun2","This"],["前","cin4","Ago"],["開","hoi1","Open"],["但","daan6","But"],["因","jan1","Because"],["只","zek3 zi2","Only"],["從","cung4 sung1 zung6","From"],["想","soeng2","Want"],["實","sat6","Real"]];
...
function nextCard(){
  ...
  var nextCard = $('.card-next'),
      ...
      word = hundred_important[index],
      index1 = Math.floor(Math.random()*100),
      index2 = Math.floor(Math.random()*100),
      index3 = Math.floor(Math.random()*100),
      answers = [
        hundred_important[index1],
        hundred_important[index2],
        hundred_important[index3],
      ];
